                                ...
                                VStack(spacing: 0){
                                    ZStack(alignment: .bottomTrailing){
                                        if let profileImage = viewModel.currentUser?.profileImageUrl, !profileImage.isEmpty{
                                            ...
                                            .overlay(
                                                Circle().stroke(Color(K.Colors.blackAndWhite).opacity(0.6), lineWidth: 2)
                                            )
                                        }else{
                                            Image(systemName: "person.circle.fill")
                                                ...
                                                .foregroundColor(Color(K.Colors.justLightGray))
                                                .overlay(
                                                    Circle().stroke(Color(K.Colors.blackAndWhite), lineWidth: 2)
                                                )
                                        }
                                        ZStack{
                                        ...
                                        Button(action: {
                                            ...
                                            ZStack(alignment: .center){
                                                if item.imageData != ""{
                                                    ...
                                                    .aspectRatio(contentMode: .fill)
                                                    .frame(width: (proxy.size.width / 2) - 45, height: 150)
                                                }else{
...
//                                                                    Text(item.timestamp, style: .time)
                                                        ...
                                                        .frame(maxWidth: proxy.size.width, maxHeight: .infinity, alignment: .bottomLeading)
                                                    }
                                            ...
                                            .frame(height: 150)
                                            .frame(maxWidth: proxy.size.width, alignment: .bottom)
                    ...
                    ToolbarItem(placement: .topBarTrailing, content: {
                        Button {
                            ...
                            Image(systemName: "bell.fill")
                                .foregroundStyle(K.Colors.mainColor)
                                .overlay(viewModel.notificationArray.isEmpty ? nil : BadgeCount(count: viewModel.notificationArray.count))
                        }
