...
struct AchievementsMainView: View {
    ...
    var body: some View {
        NavigationStack{
            List{
                Section(header: Text("Next Stage"), footer: Text("Achievement for moving to next stage.")) {
                ...
                Section(header: Text("Done"), footer: Text("Achievement for ending last app stage for person.")) {
                    ScrollView(.horizontal){
                        HStack{
