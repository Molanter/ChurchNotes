...
struct HoleImagePicker: UIViewControllerRepresentable {
    @Binding var image: UIImage?
    @Binding var isImagePickerPresented: Bool

    class Coordinator: NSObject, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
        let parent: HoleImagePicker

        init(parent: HoleImagePicker) {
            self.parent = parent
        }
    ...
    func makeUIViewController(context: Context) -> UIImagePickerController {
        ...
        imagePicker.sourceType = .photoLibrary // You can change this to .camera if you want to use the camera
