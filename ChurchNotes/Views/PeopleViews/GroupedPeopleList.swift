        ...
        List(selection: $published.selectPeopleArray){
            ZStack {
                if published.nowStage == 0 {
                    TopBarView(currentTab: self.$published.currentTab, showAddStage: false, array: sortedStages, appArray: sortedAppStages, app: true)
                }else {
                    TopBarView(currentTab: self.$published.currentTab, showAddStage: false, array: sortedStages, appArray: sortedAppStages, app: false)
                }
            }
